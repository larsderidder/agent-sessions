"""Tests for Codex session discovery."""
    ...
    records = [
        {
            ...
            "type": "session_meta",
            "payload": {"id": session_id, "cwd": "/home/lars/xithing/tether"},
        },
        {
...
def test_list_codex_sessions(monkeypatch, tmp_path: Path) -> None:
    ...
    assert sessions[0].runner_type.value == "codex"
...
def test_list_codex_sessions_empty(monkeypatch, tmp_path: Path) -> None:
